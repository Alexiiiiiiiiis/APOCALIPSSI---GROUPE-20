...
| Disque | 20–40 Go | **+2 à 4 Go rien que pour le modèle** (llama3.2:3b ≈ 4,7 Go) |
...
Sur un VPS d'entrée/milieu de gamme (CPU uniquement, **pas de GPU**), faire tourner `llama3.2:3b` pose trois problèmes concrets :
...
```bash
dcprod --profile ollama exec ollama ollama pull llama3.2:3b   # ou llama3.2:3b si VPS ≥ 16 Go
```
